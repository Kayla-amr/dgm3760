...
//COUNT FUNCTION
function countTasks(todo) {
    let count = todo.length; //GETS LENGTH OF TODO LIST
    let countTask = document.querySelector('.count'); //GETS COUNT ELEMENT
    countTask.innerText = count; //SETS COUNT ELEMENT TEXT TO COUNT
}
